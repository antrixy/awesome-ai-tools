...
- [ctxfold](https://github.com/antrixy/ctxfold) - Lossless compression of logs, JSON, and CSV that cuts LLM prompt tokens without dropping data (lossless or no-op, never lossy).
